const quota_table = {
  ...
  application: {
    ...
    total: '总应用数',
    m2m: '机器对机器',
    third_party: '开放身份连接（OIDC）/开放授权（OAuth）第三方应用',
    saml_app: '安全断言标记语言（SAML）应用',
  },
  resource: {
    title: '接口资源',
    resource_count: '资源数量',
  ...
  branding: {
    ...
    logo_and_favicon: '标志和网站图标',
    bring_your_ui: '携带你的界面',
    dark_mode: '深色模式',
    i18n: '国际化',
  },
  user_authn: {
  ...
  support: {
    ...
    discord_private_channel: 'Discord私人频道',
  ...
  developers_and_platform: {
    ...
    jwt_claims: 'JavaScript对象表示法（JSON）网络令牌（JWT）声明',
    tenant_members: '租户成员',
  },
  unlimited: '无限制',
  contact: '联系',
  ...
  mau_tip: '月活跃用户是指在计费周期内与Logto交换过至少一个令牌的独立用户数量。',
  tokens_tip: 'Logto发行的所有类型令牌，包括访问令牌、刷新令牌等。',
  mao_tip:
    'MAO（月度活跃组织）是指在计费周期内至少有一个月活跃用户（月度活跃用户）的独特组织数量。',
  third_party_tip:
    '将Logto用作你的开放身份连接（OIDC）身份提供程序，用于第三方应用的登录和权限授予。',
  ...
  extra_mao_price: '然后每MAO ${{value, number}}',
