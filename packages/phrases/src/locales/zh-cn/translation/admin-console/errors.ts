const errors = {
  ...
  empty: '没有数据',
  missing_total_number: '响应头中缺少 Total-Number',
  invalid_uri_format: '无效的地址格式',
  invalid_origin_format: '无效的来源（origin）地址格式',
  invalid_json_format: '无效的JavaScript对象表示法（JSON）格式',
  ...
  insecure_contexts: '不支持不安全的上下文（非超文本传输安全协议（HTTPS））。',
  unexpected_error: '发生未知错误',
  not_found: '404 找不到资源',
  create_internal_role_violation:
    '你正在创建一个被Logto禁止内部角色。尝试使用不以 "#internal:" 开头的其他名称。',
