const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        '删除账户将永久删除在Logto Cloud中的所有个人数据。因此，请确保在操作前备份任何重要数据。',
    ...
    request_id: '请求标识：{{requestId}}',
    try_again_later: '请稍后再试。如果问题仍然存在，请联系Logto团队并提供请求标识。',
  ...
  fields: {
    ...
    profile: '个人资料',
    profile_description: '用户可读的个人资料页面的网址（例如社交媒体资料）。',
    website: '网站',
    website_description: '用户的个人网站或博客的网址。',
    gender: '性别',
    gender_description: '用户自我认同的性别（例如“女性”、“男性”、“非二元性别”）。',
    birthdate: '出生日期',
    birthdate_description: '用户的出生日期，格式为“MM-dd-yyyy”。',
    zoneinfo: '时区',
    zoneinfo_description: '用户的时区，采用IANA格式（例如“America/New_York”或“Europe/Paris”）。',
    locale: '语言',
    locale_description: '用户的语言，采用IETF BCP 47 格式（例如“en-US”或“zh-CN”）。',
    address: {
      formatted: '地址',
      streetAddress: '街道地址',
      locality: '城市',
