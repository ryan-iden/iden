const user_details = {
  ...
  field_profile: '个人资料',
  field_profile_tip:
    '其他开放身份连接标准声明，这些声明不包含在用户的属性中。请注意，所有未知属性将被删除。请参考 <a>profile属性参考</a> 以获取更多信息。',
  field_connectors: '社交帐号',
  field_sso_connectors: '企业连接',
  custom_data_invalid: '自定义数据必须是有效的JavaScript对象表示法（JSON）对象',
  profile_invalid: '个人资料必须是有效的JavaScript对象表示法（JSON）对象',
  ...
  suspend_user_reminder:
    '确定要禁用该用户吗？该用户将无法登录到你的应用程序，并且在当前访问令牌过期后，将无法获取新的访问令牌。此外，此用户发出的任何接口请求都将失败。',
  suspend_action: '禁用',
  ...
  roles: {
    ...
    assign_subtitle: '通过搜索名称、描述或角色标识找到合适的用户角色。',
  ...
  personal_access_tokens: {
    ...
    empty: '该用户没有任何个人访问令牌。',
    create: '创建新令牌',
    tip: '个人访问令牌（PATs）为用户提供了一种安全的方式来授予访问令牌，而无需使用其凭据和交互式登录。这对于需要以编程方式访问资源的CI/CD、脚本或应用程序非常有用。',
    value: '值',
    created_at: '创建于',
    expires_at: '到期于',
    never: '从不',
  ...
  sessions: {
    title: '会话',
    description:
      '管理由Logto授权服务器维护的会话。在这里撤销Logto会话将阻止未来授权请求的自动同意。',
    field_name: '会话',
    multiple_signed_in: '该用户已在多个设备或浏览器上登录。',
    not_found: '未找到活动的Logto会话。该用户当前未在任何设备上登录。',
    name_column: '名称',
    session_id_column: '会话标识',
    location_column: '位置',
  ...
  third_party_apps: {
    title: '第三方应用',
    description: '使用Logto作为身份提供商来授权第三方应用。查看并管理该用户已授权访问的应用。',
    field_name: '已授权第三方应用',
