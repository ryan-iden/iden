const tenant_members = {
  ...
  assign_admin_confirm_self_hosted:
    'Вы уверены, что хотите сделать выбранного пользовател(ей) администратором? Предоставление прав админа даст пользователю(ям) следующие разрешения.<ul><li>Добавлять или удалять соавторов</li><li>Удалять арендатора</li></ul>',
