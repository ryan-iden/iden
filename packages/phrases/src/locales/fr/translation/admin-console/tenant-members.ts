const tenant_members = {
  ...
  assign_admin_confirm_self_hosted:
    "Êtes-vous sûr de vouloir rendre le(s) utilisateur(s) sélectionné(s) administrateur? Accorder l'accès administrateur donnera au(x) utilisateur(s) les autorisations suivantes.<ul><li>Ajouter ou supprimer des collaborateurs</li><li>Supprimer le locataire</li></ul>",
