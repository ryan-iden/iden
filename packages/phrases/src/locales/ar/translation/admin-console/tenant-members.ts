const tenant_members = {
  ...
  assign_admin_confirm_self_hosted:
    'هل أنت متأكد أنك تريد جعل المستخدم (أو المستخدمين) المحددين مسؤولين؟ ستمنح صلاحيات المسؤول للمستخدم (أو المستخدمين) التالية.<ul><li>إضافة أو إزالة المشاركين</li><li>حذف المستأجر</li></ul>',
