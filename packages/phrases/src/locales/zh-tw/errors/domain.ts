const domain = {
  ...
  cloudflare_data_missing: 'cloudflare_data缺失，請確認。',
  cloudflare_unknown_error: '在請求Cloudflare介面時出現未知錯誤',
  cloudflare_response_error: '從Cloudflare收到意外回應',
  limit_to_one_domain: '您只能擁有一個自訂網域。',
  hostname_already_exists: '此網域名稱已經存在我們的伺服器中。',
  cloudflare_not_found: '無法找到Cloudflare中的主機名',
