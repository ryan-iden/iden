const roles = {
  ...
  title: '角色',
  subtitle:
    '以角色為基礎的存取控制是一種訪問控制方法，它使用角色來決定用戶可以做什麼事情，包括授予用戶訪問特定資源的權限。',
  create: '建立角色',
  role_name: '角色名稱',
  role_type: '角色類型',
  type_user: '使用者',
  ...
  search: '按角色名稱、描述或識別碼搜尋',
  placeholder_title: '角色',
  placeholder_description: '角色是可以分配給使用者的權限分組。在建立角色之前，請確保先新增權限。',
  assign_roles: '分配角色',
  management_api_access_notification: '要訪問Logto管理介面，請選擇具有管理介面權限的角色 <flag/>。',
  with_management_api_access_tip: '此機器對機器角色包含Logto管理介面權限',
