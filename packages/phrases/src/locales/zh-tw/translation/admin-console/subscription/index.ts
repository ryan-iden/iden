...
const subscription = {
  free_plan: '免費方案',
  free_plan_description: '適用於旁邊項目和開始使用Logto的試用。無需信用卡。',
  pro_plan: '專業方案',
  pro_plan_description: '企業無憂享受Logto服務。',
  enterprise: '企業方案',
  ...
  payment_error:
    '偵測到付款問題。無法處理以前週期的 {{price, number}}$ 。更新付款以避免Logto服務中止。',
  downgrade: '降級',
  current: '當前',
  upgrade: '升級',
  quota_table,
  ...
  cancel_feedback_modal: {
    title: '很遺憾你要離開',
    description: '你的訂閱已取消。你的回饋將幫助我們把Logto做得更好。每一則回覆我們都會認真閱讀。',
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      '你目前的使用量超過了 <name /> 允許的範圍。Logto現已正式發布，包括針對每個計劃量身定制的功能。在考慮升級到 <name /> 之前，請確保你符合以下升級條件。',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      '你幾乎達到令牌使用限制。如果使用量超過 100%，Logto將停止提供令牌。請升級免費方案以避免任何不便。',
    dev_plan_exceeded: "此租戶已達到Logto's實體限制政策的令牌限制。",
  },
};
