const quota_item = {
  ...
  resources_limit: {
    name: '介面資源',
    limited: '{{count, number}} 介面資源',
    limited_other: '{{count, number}} 介面資源',
    unlimited: '不限介面資源數',
    not_eligible: '移除你的介面資源',
  },
  ...
  hooks_limit: {
    name: '事件回呼',
    limited: '{{count, number}}個事件回呼',
    limited_other: '{{count, number}}個事件回呼',
    unlimited: '無限制的事件回呼',
    not_eligible: '移除你的事件回呼',
  },
  ...
  custom_jwt_enabled: {
    name: '自訂JavaScript物件表示法（JSON）網路權杖（JWT）',
    limited: '自訂JavaScript物件表示法（JSON）網路權杖（JWT）',
    unlimited: '自訂JavaScript物件表示法（JSON）網路權杖（JWT）',
    not_eligible: '移除你的JavaScript物件表示法（JSON）網路權杖（JWT）声明自訂器',
  },
  ...
  idp_initiated_sso_enabled: {
    name: '身分提供者啟動的單一登入',
    limited: '身分提供者啟動的單一登入',
    unlimited: '身分提供者啟動的單一登入',
    not_eligible: '不允許身分提供者啟動的單一登入',
  },
  saml_applications_limit: {
    name: '安全斷言標記語言（SAML）應用程式',
    limited: '{{count, number}} 安全斷言標記語言（SAML）應用程式',
    limited_other: '{{count, number}} 安全斷言標記語言（SAML）應用程式',
    unlimited: '不限安全斷言標記語言（SAML）應用程式數',
    not_eligible: '移除你的安全斷言標記語言（SAML）應用程式',
  },
  captcha_enabled: {
    name: '驗證碼',
    limited: '驗證碼',
