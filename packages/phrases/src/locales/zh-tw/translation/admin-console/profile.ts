const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        '刪除賬戶會永久刪除Logto Cloud中的所有個人數據。因此，請在繼續之前備份任何重要數據。',
  ...
  fields: {
    ...
    profile: '個人資料',
    profile_description: '用戶可讀的個人資料頁面網址（例如社交媒體個人資料）。',
    website: '網站',
    website_description: '用戶的個人網站或部落格網址。',
    gender: '性別',
    ...
    locale: '語言',
    locale_description: '用戶的語言，格式為IETF BCP 47（例如 "en-US" 或 "zh-CN"）。',
    address: {
      formatted: '地址',
      streetAddress: '街道地址',
      locality: '城市',
