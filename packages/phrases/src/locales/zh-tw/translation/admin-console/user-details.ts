const user_details = {
  ...
  field_profile: '個人資料',
  field_profile_tip:
    '其他開放身分連接標準聲明，未包含在用戶屬性中。請注意，所有未知屬性將被去除。更多資訊請參閱<a>個人資料屬性參考</a>。',
  field_connectors: '社交帳號',
  field_sso_connectors: '企業連接',
  custom_data_invalid: '自定義數據必須是有效的JavaScript物件表示法（JSON）對象',
  profile_invalid: '個人資料必須是有效的JavaScript物件表示法（JSON）對象',
  ...
  suspend_user_reminder:
    '你確定要禁用這個用戶嗎？用戶將無法登錄你的應用程式，並且在當前令牌過期後將無法獲取新的訪問令牌。此外，此用戶發出的任何介面請求都將失敗。',
  suspend_action: '禁用',
  ...
  roles: {
    ...
    assign_subtitle: '通過搜索名稱、描述或角色識別碼找到合適的使用者角色。',
  ...
  personal_access_tokens: {
    ...
    empty: '該用戶沒有任何個人訪問令牌。',
    create: '創建新令牌',
    tip: '個人訪問令牌（PATs）為用戶提供了一種不使用其憑證和交互式登錄情況下授予訪問令牌的安全方式。這對於CI/CD、腳本或需要以程式化方式訪問資源的應用程式非常有用。',
    value: '值',
    created_at: '創建於',
    expires_at: '過期於',
    never: '永不',
  ...
  sessions: {
    title: '會話',
    description: '管理由Logto授權服務器維護的會話。撤銷Logto會話將阻止未來授權請求的自動同意。',
    field_name: '會話',
    multiple_signed_in: '該用戶已在多個設備或瀏覽器上登入。',
    not_found: '未找到活動的Logto會話。用戶當前未在任何設備上登入。',
    name_column: '名稱',
    session_id_column: '會話識別碼',
    location_column: '位置',
  ...
  connections: {
    title: '連接',
    description: '用戶連結第三方帳戶以進行社交登入、企業單一登入或資源訪問。',
