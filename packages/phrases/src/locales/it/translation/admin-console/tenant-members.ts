const tenant_members = {
  ...
  assign_admin_confirm_self_hosted:
    "Sei sicuro di voler rendere amministratore i(e) ​​utente(i)​​ selezionato(i)​​? Concedere l'accesso da amministratore fornirà al(i)​​ utente(i)​​ le seguenti autorizzazioni.<ul><li>Aggiungere o rimuovere collaboratori</li><li>Eliminare l'inquilino</li></ul>",
