const tenant_members = {
  ...
  assign_admin_confirm_self_hosted:
    'آیا مطمئن هستید که می‌خواهید کاربر(ان) انتخاب‌شده را مدیر کنید؟ اعطای دسترسی مدیر به کاربر(ان) مجوزهای زیر را می‌دهد.<ul><li>افزودن یا حذف همکاران</li><li>حذف مستأجر</li></ul>',
