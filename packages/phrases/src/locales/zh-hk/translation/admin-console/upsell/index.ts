...
const upsell = {
  ...
  create_tenant: {
    title: '選擇您的租戶計劃',
    description:
      'Logto提供創新且經濟實惠的定價計劃，旨在為不斷發展的公司提供競爭優勢。 <a>了解更多</a>',
    base_price: '基礎價格',
  ...
  mau_exceeded_modal: {
    title: '每月活躍使用者超出限制，請升級您的計劃。',
    notification:
      '您當前的每月活躍使用者已超過<planName/>的限制。請立即升級到高級計劃，以避免Logto服務的暫停。',
    update_plan: '更新計劃',
  },
  token_exceeded_modal: {
    title: '權杖使用超出限制。請升級您的計劃。',
    notification:
      '你已超出<planName/>的權杖使用限制。用戶將無法正常訪問Logto服務。請及時升級你的計劃至高級，以避免任何不便。',
  },
  ...
  convert_to_production_modal: {
    ...
    benefits: {
      ...
      keep_pro_features: '保持Pro功能：你將訂閱Pro計劃。<a>查看Pro功能。</a>',
