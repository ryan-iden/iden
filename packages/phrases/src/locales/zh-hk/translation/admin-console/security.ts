const security = {
  ...
  bot_protection: {
    custom_ui_captcha_notice:
      '你正在使用自訂介面。如要在其中啟用人機驗證，需要額外設定。<a>查看設定指南</a>。',
    title: '機器人保護',
    description: '為註冊、登入和密碼重設啟用人機驗證以阻止自動化威脅。',
    captcha: {
      title: '人機驗證',
      placeholder: '選擇一個人機驗證供應商並設定整合。',
      add: '新增人機驗證',
    },
    settings: '設定',
  ...
  captcha_providers: {
    recaptcha_enterprise: {
      ...
      description:
        'Google的企業級人機驗證解決方案，提供先進的威脅偵測和詳細的安全分析，以保護你的網站免受詐騙活動的侵害。',
    },
    turnstile: {
  ...
  captcha_details: {
    ...
    options_change_captcha: '更改人機驗證供應商',
    connection: '連接',
    description: '配置你的人機驗證連接。',
    site_key: '站點金鑰',
    secret_key: '私密金鑰',
    project_id: '項目識別碼',
    domain: '網域（可選）',
    ...
    recaptcha_api_key: '項目的介面金鑰',
    deletion_description: '你確定要刪除此人機驗證供應商嗎？',
    captcha_deleted: '人機驗證供應商已成功刪除',
    setup_captcha: '設定人機驗證',
    mode: '驗證模式',
    mode_invisible: '無感驗證',
    mode_checkbox: '複選框驗證',
  ...
  password_policy: {
    ...
    minimum_length: '最小長度',
    minimum_length_description: 'NIST建議在Web產品中使用至少 8 個字符。',
    ...
    password_expiration_description:
      '要求用戶在設定的天數後重置密碼。通過單一登入或通行密鑰登錄的用戶不受影響。',
  ...
  blocklist: {
    ...
    custom_email_allowlist: {
      title: '允許自訂電子郵件地址',
      description:
        '新增規則，只允許特定的電子郵件網域、電子郵件地址或萬用字元模式用於新註冊和新綁定的電子郵件。例如：bar@example.com、@example.com、foo*@example.com、*@example.com。gmail.com和googlemail.com網域會被視為等同，且本地部分中的點號會被忽略，因此foo.bar@gmail.com與foobar@googlemail.com相符。',
    ...
    email_subaddressing: {
      title: '封鎖電子郵件子地址',
      description:
        '啟用以拒絕使用帶有加號（+）和其他字符（例如user+alias@foo.com）的電子郵件子地址的註冊嘗試。',
    },
