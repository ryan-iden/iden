const session = {
  ...
  connector_validation_session_not_found: '找不到連接器用於驗證權杖的信息。',
  ...
  mfa: {
    ...
    mfa_sign_in_only: '多因素驗證只能用於登錄互動。',
    pending_info_not_found: '未找到等待中的多因素驗證資訊，請先啟動多因素驗證。',
    invalid_totp_code: '無效的時間型一次性密碼（TOTP）驗證碼。',
    webauthn_verification_failed: '網路身分驗證（WebAuthn）驗證失敗。',
    webauthn_verification_not_found: '未找到網路身分驗證（WebAuthn）驗證。',
    bind_mfa_existed: '多因素驗證已存在。',
    backup_code_can_not_be_alone: '備用碼不能作為唯一多因素驗證。',
    backup_code_required: '備用碼是必需的。',
    invalid_backup_code: '無效的備用碼。',
    mfa_policy_not_user_controlled: '多因素驗證政策不受使用者控制。',
  ...
  passkey_sign_in: {
    ...
    sso_users_not_allowed: '單一登入用戶無法使用通行金鑰登入選項。',
  },
  password_expiration: {
    reset_not_allowed: '只有在目前登入階段的密碼已過期後，才允許重設密碼。',
  },
  sso_enabled: '該郵箱已開啟單點登錄，請使用單一登入登錄。',
  captcha_required: '需要人機驗證。',
  captcha_failed: '人機驗證驗證失敗。',
  email_blocklist: {
