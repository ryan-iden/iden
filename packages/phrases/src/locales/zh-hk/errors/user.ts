const user = {
  ...
  sso_identity_not_exist: '該企業單一登入帳戶尚未註冊。',
  ...
  role_exists: '角色識別碼 {{roleId}} 已添加到此使用者',
  invalid_role_type: '無法設置機械到機械角色給使用者。',
  suggest_mfa: '為提升帳戶安全性，我們建議你將多因素驗證綁定到你的帳戶。',
  missing_mfa: '你需要在登錄前綁定額外的多因素驗證。',
  ...
  username_required: '使用者名稱是必填識別符，你不能將其設為null。',
  email_or_phone_required: '電子郵件地址或手機號碼是必填識別符，至少需要一個。',
  last_sign_in_method_required: '你的帳戶至少需要保留一種可用的登入方式。',
  email_required: '電子郵件地址是必填識別符，你不能將其設為null。',
  phone_required: '手機號碼是必填識別符，你不能將其設為null。',
  enterprise_sso_identity_not_exists:
    '該使用者沒有企業身份鏈接到指定的單一登入連接器識別碼：{{ ssoConnectorId }}。',
