...
import { organizationCenterPhrasesZhCn, withOrganizationCenter } from '../organization-center.js';
...
const zh_cn = {
  translation: {
    ...
    user_scopes,
    profile,
    account_center: withOrganizationCenter(account_center, organizationCenterPhrasesZhCn),
    passkey_sign_in,
  },
