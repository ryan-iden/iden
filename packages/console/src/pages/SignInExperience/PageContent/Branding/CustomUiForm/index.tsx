...
function CustomUiForm() {
  ...
  const isBringYourUiEnabled =
    isSelfHostedParityEnabled || currentSubscriptionQuota.bringYourUiEnabled;
      ...
      {(isCloud || isSelfHostedParityEnabled) && (
        <Card>
          <FormSectionTitle
            ...
            featureTag={cond(
              isCloud && { isVisible: !isBringYourUiEnabled, plan: latestProPlanId }
            )}
          />
          <FormField
